...
<div class="container">
    <div id="main">
        ...
        <nav aria-label="breadcrumb">
            <ul class="breadcrumb bg-dark">
                <li class="breadcrumb-item active">
                    <span class="btn btn-light active" style="padding: 5px">이용약관</span>
                </li>
        ...
        <div class="card card-body bg-dark" style="margin: 10px 30px 0 50px; color: white;">
            <h3>사이트 이용약관</h3>
            <form>
...
참고로 네이버는 ‘개인정보 유효기간제’에 따라 1년간 서비스를 이용하지 않은 회원의 개인정보를 별도로 분리 보관하여 관리하고 있습니다.
        ...
        <div class="text-center" style="margin: 15px 0">
            <button class="btn btn-outline-warning" type="button" id="notagree" onclick="history.go(-1)"><i class="fas fa-times"></i> 그만두기</button>
            <button class="btn btn-outline-primary" type="button" id="agreebtn"><i class="fas fa-check"></i> 확인완료</button>
        </div>
