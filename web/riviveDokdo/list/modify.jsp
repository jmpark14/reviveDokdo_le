...
<div class="container">
    <div id="main" style=" margin: 20px 0">
        <div style="color: white">
            <i class="fas fa-edit fa-2x"> <strong>게시판 - </strong><small>수정하기</small></i>
        </div>
        <hr>
        ...
        <div class="col-1"></div>
            <form style="background: #E5E5E5; color: #E5E5E5; border-radius: 10px" class="card card-body bg-dark col-10" name="brdfrm" action="${pageContext.request.contextPath}/modifyServlet" method="post">
                <div class="form-group row">
                    ...
                    <input style="background: #E5E5E5" type="text" id="title" name="title" class="form-control col-9" placeholder="글 제목을 입력하세요(*필수)" value="<%=title%>">
                </div>
