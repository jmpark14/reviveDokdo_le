...
<div class="container">
    <div id="main" style=" margin: 20px 0">
        ...
        <div class="row" style="margin: 30px 0px">
            ...
            <form style="color: #E5E5E5; border-radius: 10px" class="card card-body bg-dark col-10" name="brdfrm" action="${pageContext.request.contextPath}/writeServlet" method="post" enctype="multipart/form-data">
                <div class="form-group row">
                    <label class="col-form-label col-2 text-right" for="listtitle"><strong>글 제목</strong></label>
                    <input style="background: #E5E5E5" type="text" id="listtitle" name="listtitle" class="form-control col-9" placeholder="글 제목을 입력하세요(*필수)">
                </div>
                ...
                <div class="form-group row">
                    ...
                    <input class="custom-control-input" type="file" id="file" name="file" accept=".zip, .jpeg, .gif, .png, .txt, .docx, .hwp" onchange="checkUploadFile(this)">
